...
class OrdersScreenBusiness extends StatefulWidget {
  const OrdersScreenBusiness({Key? key}) : super(key: key);

  @override
  _OrdersScreenBusinessState createState() => _OrdersScreenBusinessState();
}

class _OrdersScreenBusinessState extends State<OrdersScreenBusiness> {
      ...
      return Container(
        ...
        child: GridView.count(
          ...
          children: data.map((e) {
            return InkWell(
              onTap: () {
                Navigator.pushNamed(context, '/orders_details_screen_business');
              },
              child: Container(
                width: 335,
                height: 88,
