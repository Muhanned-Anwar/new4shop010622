...
class OrderReviewScreenBusiness extends StatefulWidget {
  const OrderReviewScreenBusiness({Key? key}) : super(key: key);

  @override
  _OrderReviewScreenBusinessState createState() => _OrderReviewScreenBusinessState();
}

class _OrderReviewScreenBusinessState extends State<OrderReviewScreenBusiness> {
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, '/view_invoice_screen_business');
                  },
                  child: Row(
