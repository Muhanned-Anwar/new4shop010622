...
class FreshFruitsBusiness extends StatefulWidget {
  const FreshFruitsBusiness({Key? key}) : super(key: key);

  @override
  _FreshFruitsBusinessState createState() => _FreshFruitsBusinessState();
}

class _FreshFruitsBusinessState extends State<FreshFruitsBusiness> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushNamed(context, '/new_item_screen');
        },
  ...
  Visibility appBarActions() {
    return Visibility(
      ...
      replacement: IconButton(
        ...
        icon:
            Image.asset('images/app/FruitsAndVegetables/fresh_fruits/grid.png'),
      ),
    );
  }
