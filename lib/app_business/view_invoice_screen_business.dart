...
class ViewInvoiceScreenBusiness extends StatefulWidget {
  const ViewInvoiceScreenBusiness({Key? key}) : super(key: key);

  @override
  _ViewInvoiceScreenBusinessState createState() => _ViewInvoiceScreenBusinessState();
}

class _ViewInvoiceScreenBusinessState extends State<ViewInvoiceScreenBusiness> {
  @override
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  const Text('job id : #99658',style: TextStyle(color: Colors.grey),),
...
Cedar City, UT 84720, USA'''),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: const [
                  Text('Consumer Name',style: TextStyle(color: Colors.grey),),
